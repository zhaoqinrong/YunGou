            ...
            <div class="tables">
                <div class="bs-example widget-shadow" data-example-id="contextual-table">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <c:forEach items="${allNewsAndClass}" var="news" varStatus="stus">
                            <c:choose>
                            ...
                            <td name="className">${news.className}</td>
                            <td name="id" hidden>${news.id}</td>
                            <td name="title">${news.title}</td>
                            <td name="content" hidden>${news.content}</td>
                            <td name="createTime">${news.createTime}</td>

                            <td>
                                <a href="../EasyBuyNews?action=getNewsBuyId&id=${news.id}" role="button" data-toggle="modal" ><i class=" glyphicon glyphicon-eye-open" ></i></a>
