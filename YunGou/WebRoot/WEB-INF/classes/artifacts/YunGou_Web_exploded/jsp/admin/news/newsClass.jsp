            ...
            <div class="tables">
                <div class="bs-example widget-shadow" data-example-id="contextual-table">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <c:forEach items="${newsClass.list}" var="newsclass" varStatus="stus">
                            <c:choose>
                            ...
                            <td name="cid">${newsclass.cid}</td>
                            <td name="className">${newsclass.className}</td>
                    ...
                    <nav class="col-md-offset-4">
                        <ul class="pagination pagination-lg">
                            <c:if test="${newsClass.currPage==1}">
                                <li class="disabled"><a href="javascript:void(0);" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
                            </c:if>
                            <c:if test="${newsClass.currPage !=1}">
                                <li ><a href="${pageContext.request.contextPath}/news?action=getAllClassPages&currPage=${newsClass.currPage-1}" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
                            </c:if>
                            <c:forEach begin="1" end="${newsClass.pages}" var="page">
                                <c:if test="${newsClass.currPage==page}">
                                    <li class="active"><a href="${pageContext.request.contextPath}/news?action=getAllClassPages&currPage=${page}">${page}</a></li>
                                </c:if>
                                <c:if test="${newsClass.currPage !=page}">
                                    <li><a href="${pageContext.request.contextPath}/news?action=getAllClassPages&currPage=${page}">${page}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${newsClass.currPage== newsClass.pages}">
                                <li class="disabled"><a href="javascript:void(0)" aria-label="Previous"><span aria-hidden="true">»</span></a></li>
                            </c:if>
                            <c:if test="${newsClass.currPage != newsClass.pages}">
                                <li ><a href="${pageContext.request.contextPath}/news?action=getAllClassPages&currPage=${newsClass.currPage+1}" aria-label="Previous"><span aria-hidden="true">»</span></a></li>
