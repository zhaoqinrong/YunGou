                ...
                <div class="bs-example widget-shadow" data-example-id="contextual-table">
                    ...
                    <table class="table">
                        ...
                        <tr class="active">
                            ...
                            <td name="className">${newsAndClass.className}</td>
                            <td name="id" hidden>${newsAndClass.id}</td>
                            <td name="title">${newsAndClass.title}</td>
                            <td name="content">${newsAndClass.content}</td>
                            <td name="createTime">${newsAndClass.createTime}</td>
...
<script src="${pageContext.request.contextPath}/jsp/adminjs/jquery.validate.min.js"></script>
