...
<link rel="${pageContext.request.contextPath}/static/shortcut icon" type="image/x-icon"
	href="${pageContext.request.contextPath}/static/img/icon/favicon.ico">
...
<body>
	...
	<section>
		<div class="pc-login-bj">
			...
			<%--			<%
					...
					<form action="${pageContext.request.contextPath}/user?action=login" id="myForm" method="post">
						<div class="pc-sign">
							<input type="text" name="loginName" placeholder="用户名"
								value="${user.loginName}" style="display: block">
                            <input type="hidden" name="action" value="login" >
							<div id="user_prompt"></div>
						</div>
						<div class="pc-sign">
							<input type="password" name="password" placeholder="请输入您的密码"
								value="${user.password}" style="display: block">
						...
						<div class="pc-item-san clearfix">
							<a href="https://wx.qq.com/"><img src="${pageContext.request.contextPath}/static/img/icon/weixin.png"
								alt="">微信登录</a> <a href="https://weibo.com/"><img
								src="${pageContext.request.contextPath}/static/img/icon/weibo.png" alt="">微博登录</a> <a
    ...
    <script src="${pageContext.request.contextPath}/static/js/gt.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/loginValidate.js"></script>
