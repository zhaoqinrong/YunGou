package cn.yungou.user.dao.util;
...
public class ResultSetUtil {
    ...
    public static <T> List<T> eachResult(ResultSet resultSet, Class<T> clazz) {
        ...
        try {
        	...
        	logger.error(e+"ResultSetUtil.eachResult()抛出SQLException异常");
        } catch (IllegalAccessException e) {
        	logger.error(e+"ResultSetUtil.eachResult()抛出IllegalAccessException异常");
        } catch (InstantiationException e) {
        	logger.error(e+"ResultSetUtil.eachResult()抛出InstantiationException异常");
        }
        return list;
    }
    ...
    public static <T> T findOne(ResultSet rs, Class<T> clazz) {
        ...
        try {
        	...
        	logger.error(e+"ResultSetUtil.findOne()抛出SQLException异常");
         
        } catch (IllegalAccessException e) {
        	logger.error(e+"ResultSetUtil.findOne()抛出IllegalAccessException异常");
        } catch (InstantiationException e) {
        	logger.error(e+"ResultSetUtil.findOne()抛出InstantiationException异常");
        }
        return object;
    }
}
